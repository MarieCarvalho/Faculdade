...
public class PacienteBuilder {
    ...
    public  PacienteBuilder doEndereco(String cep, String logradouro, int numero, String cidade, String uf){
    ...
    public PacienteBuilder comAltura(double altura){
     ...
     public PacienteBuilder comTipoSanguineo(String tipoSangue){
